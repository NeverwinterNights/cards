...
function ButtonForTable({ m, packId, ownerId }: ButtonForTablePropsType) {
		...
		<div className={s.wrapper}>
			{autorisedUserId === ownerId && (
				<div className={s.wrapBtn}>
					<button className={s.btnRed} onClick={deleteHandler}>
						Delete
					</button>
					{isEdit ? (
						<TextField
						...
						<button className={s.btnEdit} onClick={() => setIsEdit(true)}>
							Edit
						</button>
					)}
				</div>
